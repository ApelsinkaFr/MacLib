...
function MacLib:Window(Settings)
		...
		function SectionFunctions:Tab(Settings)
			...
			function TabFunctions:Section(Settings)
				...
				function SectionFunctions:Slider(Settings, Flag)
					...
					sliderElementsUIListLayout.Padding = UDim.new(0, -1)
					...
					sliderBarUIPadding.PaddingLeft = UDim.new(0, 15)
					sliderBarUIPadding.PaddingRight = UDim.new(0, 2)
	...
	function WindowFunctions:SetAcrylicBlurState(State)
		acrylicBlur = State
		base.BackgroundTransparency = State and 0.05 or 0.1
	end
